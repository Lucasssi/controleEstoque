...
if ($_SESSION['login'] == "ativo") {
    ...
    <html lang="pt-br">
        ...
        <head>
            ...
            <title> DEPARTAEMNTO RELACIONADO - CONTROLE DE ESTOQUE - ASSIS </title>
...
<!--                    <div class="navbar-default sidebar" role="navigation">
                ...
                if (isset($_GET['adicionar'])) {
                  ...
                  $VeridicarDepartamento =  DaoDepartamentoFuncionario::getVerificarEntrada($_SESSION['FuncionarioS'], $_GET['id']);
                  
                  if($VeridicarDepartamento == $_GET['id'])
                  {
                      
                  }
                  else
                  {
                      DaoDepartamentoFuncionario::inserir($_SESSION['FuncionarioS'], $_GET['id']);
                  }
                ...
                if (isset($_GET['Excluir'])) {
                    DaoDepartamentoFuncionario::excluir($_GET['id']);
                }
...
<!--                    <div class="row">-->
<!--                        <div class="col-lg-12">-->
                            <h2 class="page-header">RELACIONAR FUNCIONARIO A DEPARTAMENTO</h2>
...
<!--                        <p>ID:   <?php// echo $_SESSION['id_funcionario']; ?></p>
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                   LISTA DE FUNCIONARIOS CLIENTES
                                </div>
                                <!-- /.panel-heading -->
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
    <?php
    $vFuncClientes = DaoFuncionario::getTodosClientes();
    ...
    foreach ($vFuncClientes as $FuncCli) {
        ?>
                                                    <tr>
                                                        ...
                                                        <td><a href='GerenciarClientes.php?FuncionarioS&id=<?php echo $FuncCli->getId_funcionario();?>&nome=<?php echo $FuncCli->getNome();?>'>selecionar</a></td>
                                                    </tr>
    ...
    <?php
    $Vdf = DaoDepartamentoFuncionario::getDepartamentoUsuario($_SESSION['FuncionarioS']);
  //  var_dump($Vdf);
    ?>
    ...
    foreach ($Vdf as $Vdff) {
        echo '<tr>';
        echo '<td>' . $Vdff->getDepartamento()->getId_departamento_U() . '</td>';
        echo '<td>' . $Vdff->getDepartamento()->getNome() . '</td>';
        echo "<td><a  href='GerenciarClientes.php?Excluir&id=" . $Vdff->getId_departamento_usuario() . "'>Excluir</a></td>";
        echo '</tr>';
    }
    ?>
    ...
    foreach ($vDepartamneto as $departamentoo) {
        ...
        echo "<td>";
        echo "<a href='GerenciarClientes.php?adicionar&id=" . $departamentoo->getId_departamento_U() . "'> ADICIONAR </a>";
        echo "</td>";
        echo '</tr>';
    }
    echo '</tbody>';
