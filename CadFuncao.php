...
<html lang="pt-br">
    ...
    <head>
        ...
        <title> CADASTRO DE FUNÇÃO - CONTROLE DE ESTOQUE - ASSIS </title>
...
<!--                    <ul class="nav" id="side-menu">
            ...
            if (isset($_POST['enviar'])) {
                ...
                $funcao->setId_Funcao_U($_POST['id_Funcao_U']);
                $funcao->setNome($_POST['nome']);
                
                $testenome = DaoFuncao_U::getFuncaoNome($_POST['nome']);
...
//                echo var_dump($_POST['nome']);
                ...
                if ($funcao->getId_Funcao_U() <= 0) {
                     if($testenome == $_POST['nome']){
                       
                            $_SESSION['NomeExistente'] = $testenome;

                    }else{
                         $retorno = DaoFuncao_U::inserir($funcao);
                    }
                     ...
                     if($testenome == $_POST['nome']){
                        ...
                        $retorno = DaoFuncao_U::alterar($funcao);
            ...
            if (isset($_GET['op'])) {
                $operacao = $_GET['op'];
                if ($operacao == "alterar") {
                    $funcao = DaoFuncao_U::getFuncao($_GET['id']);
                }
            }
            ?>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                CADASTRO DE FUNÇÃO DE USUARIOS
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="panel-body">
                                        <form role="form" action="CadFuncao.php" method="post">
                                            <div class="col-lg-6">
...
<!--                                                    teste-->
                                                        ...
                                                        A FUNÇÃO <?php echo $_SESSION['NomeExistente'];?> JA FOI CRIADA. <a href="#" class="alert-link">Alert Link</a>.
                                                        </div>
                                                        </div>
...
<!--                                                    teste-->
                                                    <label>NOME</label>
                                                    <input class="form-control" value="<?php echo $funcao->getId_Funcao_U(); ?>" type ="hidden" name="id_Funcao_U" >
                                                    <input class="form-control" value="<?php echo $funcao->getNome(); ?>" type ="text" name="nome" tabindex="1">
                                                    <p class="help-block">EXEMPLO "Secretario, Técnico Administrativo..."</p>
                                                </div>
...
if (isset($_GET['op'])) {
    ...
    if ($operacao == "alterar") {
        ?>
                                                                    <h4 class="modal-title" id="myModalLabel">DESEJA ALTERAR FUNÇÃO ?</h4>

                                                                    <?php
                                                                } else {
                                                                    ?>

                                                                    <h4 class="modal-title" id="myModalLabel">DESEJA CRIAR FUNÇÃO ?</h4>     
...
if (isset($_GET['op'])) {
    $operacao = $_GET['op'];
    if ($operacao == "remover") {
        $retorno = DaoFuncao_U::excluir($_GET['id']);
    }
}

$vFuncao = DaoFuncao_U::getTodos();
...
echo ' </thead>';
echo '<tbody>';
foreach ($vFuncao as $funcaoo) {

    echo '<tr>';
    echo "<td>" . $funcaoo->getId_Funcao_U() . "</td>";
    echo "<td>" . $funcaoo->getNome() . "</td>";
    echo "<td><a href='CadFuncao.php?op=alterar&id=" . $funcaoo->getId_Funcao_U() . "'> Alterar </a>&nbsp;";
    echo "<a href='CadFuncao.php?op=remover&id=" . $funcaoo->getId_Funcao_U() . "'> Remover </a></td>";
