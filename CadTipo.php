       ...
       require_once $_SERVER['DOCUMENT_ROOT'] . '/ControleEstoqueWebTCC/Persistencia/Conexao.php';
        ...
        if (isset($_POST['enviar'])) {
           ...
           // var_dump($tipo);;
            ...
            {
            $retorno = DaoTipo::inserir($tipo);
            } 
            else 
            {
            $retorno = DaoTipo::alterar($tipo);
            }
        ...
        ?>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="panel-body">
                                        <form role="form" action="CadTipo.php" method="post">
                                            <div class="col-lg-6">
    ...
    ?>
                                                        <div class="panel-body">
                                                            <div class="alert alert-success alert-dismissable">
                                                                ...
                                                                O TIPO <?php echo $_SESSION['NomeExistente']; ?> JA FOI CRIADA.
                                                            </div>
                                                        </div>
...
<!--                                                <input class="form-control" value="<?php //$curso->getId_curso(); ?>" type ="hidden" name="id_cursoo">-->
                                                    <input class="form-control" value="<?php  echo $tipo->getId_tipo(); ?>" type ="hidden" name="id_tipo">
                                                    <input class="form-control" value="<?php echo $tipo->getDescricao(); ?>" type ="text" name="descricao">
                                                    <p class="help-block">Segurança, Expediente, Limpeza ...</p>
...
if (isset($_GET['op'])) {
    $operacao = $_GET['op'];
    if ($operacao == "remover") {
        $retorno = DaoTipo::excluir($_GET['id']);
    }
}
              ...
              $operacao = $_GET['op'];
                  ...
                  if (isset($_GET['op'])) 
                     ...
                     <?PHP }   ?>
                           ...
                           <a class="btn btn-default" href="CadTipo.php"  >RESET</a>
...
// REMOVER AQUI ------------------------------------------------------
                         ...
                         $vTipo2 = DaoTipo::getTodos();
                          
                                echo '  <div class="panel panel-default">';
                                echo ' <div class="panel-heading">
                                   GRUPO DE CATEGORIA DE MATERIAIS
                                    </div>';
                                ...
                                echo ' </thead>';
                                echo '<tbody>';
                               foreach ($vTipo2 as $tipooo) {

                                    echo '<tr>';
                                     echo "<td>" . $tipooo->getId_tipo() . "</td>";
                                     echo "<td>" . $tipooo->getDescricao() . "</td>";
                                    ?>
                                   <!--<td>-->
                                    <?php
...
//                                    echo "<a type='button' class='btn btn-outline btn-warning'  data-toggle='modal' href='CadFuncionario.php?op=remover&id=" . $funcionario->getId_funcionario() . "'> Remover </a>";
                                      echo "<td><a href='CadTipo.php?op=alterar&id=" . $tipooo->getId_tipo() . "'> Alterar </a>&nbsp;";
                                      echo "<a href='CadTipo.php?op=remover&id=" . $tipooo->getId_tipo() . "'> Remover </a></td>";
                                    ?>
