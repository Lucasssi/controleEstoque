...
<!--                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header">Visualização de Pedido</h4>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="panel-group" id="accordion">
                                ...
                                <div class="panel panel-default">
                                  ...
                                  {
                                 $vItem = DaoItemSelecionado::getItemSelecionadoPorPedido($_POST['id_pedido']); 
                                 $id_pedido =  $_POST['id_pedido'];
                                            ...
                                            <form  action="AtenderPedido.php" method="post">
                                                <input class="form-control" value="<?php echo  $id_pedido; ?>" type ="hidden" name="id_pedido" >
                                               
                                                <td colspan="3"><center> <button type="submit" class="btn btn-default"   name="pedido"  >ATENDER</button></center></td>
...
<a class="btn btn-default btn-lg btn-block" href="homeAlmoxarifado2.php">VOLTAR</a>
            </div>
