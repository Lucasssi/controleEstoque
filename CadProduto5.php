...
//echo '<br>';
//echo "<h1>id NF -->".$_SESSION['id_NotaFiscal']."</h1>";
//echo '<br>';
...
?>
                                                    ...
                                                    <input class="form-control" value="<?php echo $MC->getCx(); ?>" type ="number" name="cx">
                                                    <p class="help-block">EXEMPLO "Escritoio, Coordenção Matematica".</p>
                                                    <br>
                                                    <label>UNIDADE POR CAIXA:</label>
                                                    <input class="form-control" value="<?php echo $MC->getCxUn(); ?>" type ="number" name="cxUn">
                                                    <p class="help-block">EXEMPLO "Escritoio, Coordenção Matematica".</p>
                                                   <br>
                                                   
                                                   
<!--                                                    <label>ESTOQUE MINIMO:</label>
                                                    <input class="form-control" value="<?php // $MC->getEstMinCx() = 0 ; ?>" type ="number" name="estMinCx">
                                                    <p class="help-block">EXEMPLO "Escritoio, Coordenção Matematica".</p>
                                                   <br>
                                                    <label>ESTOQUE MEDIO:</label>
                                                    <input class="form-control" value="<?php // $MC->getEstMedCx() = 0; ?>" type ="number" name="estMedCx">
                                                    <p class="help-block">EXEMPLO "Escritoio, Coordenção Matematica".</p>-->
                                                ...
                                                <button type="submit" class="btn btn-default"  name="enviarCaixa">SAVALR</button>
