...
<!--========================               INICIO         SOLICITADO             ================-->
                          ...
                          <div class="tab-pane fade in active" id="solicitado">
                           <div class="panel-group" id="accordion">
                             ...
                             $vPedidoSolicitado = DaoPedido::getPedidoTodosSolicitadoCliente($_SESSION['id_funcionario']);
                             ...
                             // $vItem = DaoItemSelecionado::getTodos($Pedidoo1->getId_pedido(), $Pedidoo1->getAlmox()->getId_almox());
                              $vItem = DaoItemSelecionado::getTodos($Pedidoo1->getId_pedido());
                             // var_dump($vItem);
...
<!--                                                            <th> STATUS: <?php //echo $Pedidoo1->getStatus()->getNome(); ?> </th>-->
                                                        ...
                                                        <tr>
                                                            <th >DEPARTAMENTO: <?php echo $Pedidoo1->getCurso()->getNome();?></th>
                                                          
                                                    
                                                        </tr>
                                                        <tr>
                                                            <th>USUARIO: <?php echo $Pedidoo1->getFunc_cli()->getNome();?></th>
