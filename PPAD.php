...
if($_SESSION['login'] == "ativo"){
              ...
              if ( $_SESSION['TipoCliente'] == "almoxarife")
               {
                   header("location: PPAL.php");
               } 
               if ( $_SESSION['TipoCliente'] == "Cliente")
            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="AlterarSenha2.php"><i class="fa fa-gear fa-fw"></i> ALTERAR SENHA</a>
                        </li>
                        <li class="divider"></li>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <center>
                            <figure>
                                <img src="img/GerenciarClientes.png" alt="Minha Figura" height="130" width="200">	
...
<!--                        <div class="panel-footer">
                ...
                <!-- /.col-lg-4 -->
                 <div class="col-lg-3">
                     <a href="CadCategoria2.php">
                    <div class="panel panel-primary">
                       
                        <div class="panel-heading">
                           CADASTRO DE CATEGORIA<BR>
                           E ESTOQUE MINIMO E MEDIO
                        </div>
                        <div class="panel-body">
                            <center>
                            <figure>
                                <img src="img/CATEGORIA-GRUPO.jpg" alt="Minha Figura" height="110" width="210">	
                ...
                <div class="col-lg-3">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <center>
                            <figure>
                                <img src="img/armazenamente.jpg" alt="Minha Figura" height="130" width="200">	
                ...
                <div class="col-lg-3">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <center>
                            <figure>
                                <img src="img/senha4.jpg" alt="Minha Figura" height="160" width="290">	
