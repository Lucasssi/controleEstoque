    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="CadEmpresa.php">VOLTAR AS EMPRESAS</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">DADOS DE EMPRESA</h1>
                </div>
            ...
            require_once $_SERVER['DOCUMENT_ROOT'] . '/ControleEstoqueWebTCC/Persistencia/SegundoPlanoCadEndereco.php';
            ...
            if (isset($_POST['Endereco'])) {
                $_SESSION['id_empresaa'] = $_POST['id_empresa'];
                $vEndereco = DaoEndereco::getEnderecoEmpresa($_SESSION['id_empresaa']);
                $Empresa1 = DaoEmpresa::getEmpresa($_SESSION['id_empresaa']);
                 $_SESSION['alterar'] = 0;
            ...
            <table width="100%" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    <tr>
                        <td><?php echo$Empresa1->getId_empresa()?></td>
                        <td><?php echo$Empresa1->getNome()?></td>
                        <td><?php echo$Empresa1->getNome_fantasia()?></td>
                        <td><?php echo$Empresa1->getCmpj()?></td>
                        <td><?php echo$Empresa1->getEmail()?></td>
                        <td><?php echo$Empresa1->getSite()?></td>
                        <td><?php echo$Empresa1->getSeguimento()?></td>
                    </tr>
            ...
            <table width="100%" class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td><?php echo$Empresa1->getTelefone()?></td>
                    </tr>
                    <tr>
                        <td>SEGUIMENTO</td>
                    ...
                    <tr>
                        ...
                        <td><?php echo$Empresa1->getEstado()?></td>
                    </tr>
                    <tr>
                        <td>CIDADE</td>
                        
                        <td><?php echo$Empresa1->getCidade()?></td>
                    </tr>
                    <tr>
                        <td>BAIRRO</td>
                        
                        <td><?php echo$Empresa1->getBairro()?></td>
                    </tr>
                    <tr>
                        <td>RUA</td>
                        
                        <td><?php echo$Empresa1->getRua()?></td>
                    </tr>
                    <tr>
                        <td>NUMERA</td>
                        
                        <td><?php echo$Empresa1->getNumero()?></td>
                    </tr>
