        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="PPAD.php">VOLTAR</a>
                </div>
                <!-- /.navbar-header -->
      ...
      // require_once $_SERVER['DOCUMENT_ROOT'] . '/ControleEstoqueWebTCC/Persistencia/Conexao.php';
        ...
        ?>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="panel-body">
                                        <form role="form" action="CadCategoria2.php" method="post">
                                            <div class="col-lg-6">
                               ...
                               foreach ($vCAT as $Categoria) {
                                   ...
                                   <!--<td>-->
                                    <?php
                                      ...
                                      echo "<td><a href='CadCategoria2.php?op=alterar&id=" . $Categoria->getId() . "'> Alterar </a>&nbsp;";
                                      echo "<a href='CadCategoria2.php?op=remover&id=" . $Categoria->getId() . "'> Remover </a></td>";
                                    ?>
