    ...
    <div id="wrapper">
     ...
     <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="CadProduto3.php">VOLTAR</a>
            </div>
            <!-- /.navbar-header -->
...
//            $func->setSenha("");
           ...
           if(isset($_POST['SelecionarAlmox']))  {
               
              
              $_SESSION['id_almox_NUMERO'] = $_POST['id_almox5'];
              $_SESSION['id_almox5'] = DaoAlmoxarifado::getAlmoxarifado($_POST['id_almox5']);
              $_SESSION['id_almox6'] = DaoAlmoxarifado::getAlmoxarifado($_POST['id_almox5'])->getId_almox();
                    ?>
                <!-- /.col-lg-12 -->
           
                     <center>
                         <h2 class="page-header"> O ALMOXARIFADO SELECIONADO FOI: "<?php echo $_SESSION['id_almox5']->getNome();?>"</h2>
                         <a href="CadProduto4.php" class="btn btn-primary btn-lg btn-block"   >PREENCHER PROXIMOS DADOS</a>
                    ...
                    <center>
                      ...
                      <h2 class="page-header">SELECIONE ALMOXARIFADO QUE RECEBEDOR DE PRODUTOS. </h2>
                    </center>
                    <?php
                       }
...
<!--                         <div class="col-md-4">
                        ...
                        <a href="CadAlmoxarifado.php" class="btn btn-outline btn-primary btn-lg btn-block"   >ADICIONAR NOVO ALMOXARIFADO</a>
                        <br>
                        <br>
                     </div>
            </div>
...
// REMOVER AQUI ------------------------------------------------------
                                ...
                                $vAlmox3 = DaoAlmoxarifado::getTodos();
                                ...
                                echo ' </thead>';
                                echo '<tbody>';
                                foreach ($vAlmox3 as $vAlmox31) {

                                    echo '<tr>';
                                    //echo "<td>" . $Empresaa->getId_empresa()."</td>";
                                    echo "<td>" . $vAlmox31->getNome() . "</td>";
                                   // echo "<td>" . $Empresaa->getNome_fantasia() . "</td>";
                                    echo "<td>" . $vAlmox31->getLocal() . "</td>";
//                                    echo "<td>" . $Empresaa->getSeguimento() . "</td>";
//                                    echo "<td>" . $Empresaa->getTelefone() . "</td>";
                                  //  echo '  <form  action="CadEndereco3.php" method="post">';
                                  //  echo ' <input class="form-control" value= '. $vAlmox31->getId_almox() .'  type ="hidden" name="id_almox3" >';
...
//                                  
                                    ?>
                                        ...
                                        <form  action="CadProduto3.php" method="post">
<!-- inicio de -->
...
<!-- <input class="form-control" value="<?php //echo $Cidadee->getId_cidade(); ?>" type ="text" name="id_cidadeExcluir" >-->
    ...
    <?php
     echo "<input type ='hidden'     value=" . $vAlmox31->getId_almox() . "' name='id_almox5'>";
     echo '<button type="submit" class="btn btn-default"  name="SelecionarAlmox">SELECIONAR</button>';
